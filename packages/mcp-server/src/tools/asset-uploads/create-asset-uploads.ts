...
export const metadata: Metadata = {
  ...
  tags: [],
  httpMethod: 'post',
  httpPath: '/v1/asset-uploads',
  operationId: 'CreateAssetUploadJob',
};

export const tool: Tool = {
  name: 'create_asset_uploads',
  description:
  ...
  inputSchema: {
    ...
    required: ['body', 'Asset-Upload-Metadata'],
  },
  annotations: {},
};
...
export const handler = async (client: Canva, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.assetUploads.create(body, body)));
};
