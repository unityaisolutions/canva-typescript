...
function getTSDiagnostics(code: string): string[] {
  ...
  const codeWithImport = [
    ...
    functionSource.type === 'declaration' ?
      `async function run(${functionSource.client}: Canva)`
    : `const run: (${functionSource.client}: Canva) => Promise<unknown> =`,
    functionSource.code,
  ].join('\n');
...
const fuse = new Fuse(
  [
    ...
    'client.assetUploads.create',
    'client.assetUploads.retrieve',
    'client.urlAssetUploads.create',
    'client.urlAssetUploads.retrieve',
    'client.autofills.create',
    'client.autofills.retrieve',
    'client.brandTemplates.list',
    'client.brandTemplates.retrieve',
    'client.brandTemplates.retrieveDataset',
    'client.comments.createReply',
    'client.comments.createThread',
    'client.designs.create',
    'client.designs.list',
    'client.designs.retrieve',
    'client.designs.comments.create',
    'client.designs.comments.retrieve',
    'client.designs.comments.replies.create',
    'client.designs.comments.replies.list',
    'client.designs.comments.replies.retrieve',
    'client.designs.pages.retrieve',
    'client.designs.exportFormats.retrieve',
    'client.connect.retrieveKeys',
    'client.imports.create',
    'client.imports.retrieve',
    'client.urlImports.create',
    'client.urlImports.retrieve',
    'client.exports.create',
    'client.exports.retrieve',
    'client.folders.create',
    'client.folders.delete',
    'client.folders.listItems',
    'client.folders.moveItem',
    'client.folders.retrieve',
    'client.folders.update',
    'client.oauth.createToken',
    'client.oauth.introspectToken',
    'client.oauth.revokeToken',
    'client.resizes.create',
    'client.resizes.retrieve',
    'client.users.me.listCapabilities',
    'client.users.me.retrieve',
    'client.users.me.retrieveProfile',
  ],
